...
namespace SignalR.Controllers
{
    ...
    public class ChatHub : Hub
    {
        ...
        public void UserEnter(string nickName,string userAvatarIndex)
        {
        ...
        public void SendMessage(string nickName, string userAvatarIndex, string message)
        {
            Clients.All.NotifySendMessage(nickName, userAvatarIndex, message);//调用前台NotifySendMessage方法
        }
    ...
    public class UserEntity
    {
        ...
        public string userAvatarIndex { get; set; }
